        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Software as a Service product</h1>
                    <p class="hero_description" data-aos="fade-up">
                        Offrez à vos clients et collaborateurs des outils SaaS intuitifs et performants. Nous développons
                        des solutions adaptées à vos processus métiers, permettant une gestion simplifiée et une efficacité
                        accrue. Nos produits SaaS sont conçus pour être évolutifs, sécurisés et personnalisables, répondant
                        ainsi aux besoins spécifiques de chaque utilisateur. Que ce soit pour la gestion des abonnements, la
                        facturation automatisée, ou l'intégration multi-tenants, nous vous accompagnons à chaque étape pour
                        garantir le succès de votre projet. Faites confiance à notre expertise pour transformer vos idées en
                        solutions SaaS innovantes et performantes.
                    </p>
                    <div class="cta-links-area "><button class="tp-btn"
                            onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service Saas')">Demander un
                            devis</button>
                ...
                <div class="image_hero " data-tilt="">
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper"><img class="img-fluid " src="{{ asset('img/services/saas.png') }}"
                                alt="" draggable="false">
                            <div class="radar"></div>
                            <div class="orbit"> </div>
                        </div>
            ...
            <div class="features">
                <div class="features_content">
                    <div class="headlining">
                        <div class="pre-title" data-aos="fade-up">Des Solutions SaaS Innovantes</div>
                        <h3 data-aos="fade-right">Des Solutions SaaS pour Simplifier Votre Gestion</h3>
                        <p data-aos="fade-right">
                            Simplifiez vos processus avec des produits SaaS performants et personnalisés. </p>
                    </div>
                    <article class="features_articles">
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Abonnements et Facturation Automatisée</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Gérez vos clients avec des systèmes de paiement et
                                d’abonnement simplifiés. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Intégration Multi-Tenants </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Support pour plusieurs utilisateurs ou entreprises
                                sur une seule instance.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Scalabilité Horizontale et Verticale </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Ajoutez des ressources à mesure que votre
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Personnalisation pour Chaque Client </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Offrez des fonctionnalités ajustées selon les
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Analyses en Temps Réel </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Tableaux de bord pour surveiller les performances
                                de vos produits. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Mises à Jour Automatiques</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Déployez de nouvelles fonctionnalités sans
                                interruption.</p>
                        </div>

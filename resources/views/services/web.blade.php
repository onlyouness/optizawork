        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Développement Web</h1>
                    <p class="hero_description" data-aos="fade-up">Boostez votre présence en ligne avec des sites web
                        modernes, performants et adaptés à vos besoins. Nous créons des sites web sur mesure qui reflètent
                        votre identité et répondent aux attentes de vos utilisateurs. Que vous ayez besoin d'un site
                        vitrine, d'un site e-commerce ou d'une plateforme complexe, notre équipe d'experts est là pour vous
                        accompagner à chaque étape de votre projet. Profitez d'une expérience utilisateur optimale et d'un
                        design responsive qui s'adapte à tous les appareils.</p>

                    <div class="cta-links-area "><button class="tp-btn"
                            onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service Web')">Demander un
                            devis</button>
                ...
                <div class="features_content">
                    <div class="headlining">
                        ...
                        <p data-aos="fade-right">
                            Nous concevons des sites web modernes, performants et adaptés à vos objectifs. Que vous ayez
                            besoin d’un
                            site vitrine, e-commerce ou d’une plateforme personnalisée, notre expertise garantit une
                            présence en
                            ligne impeccable.
                        </p>
                    </div>
                    <article class="features_articles">
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">Design
                                    Réactif</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Optimisé pour tous les écrans
                                (ordinateurs, tablettes, mobiles) avec une expérience utilisateur cohérente.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Optimisation des Performances</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Chargement rapide pour améliorer l’expérience
                                utilisateur et le référencement naturel (SEO).</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Système
                                    de Gestion de Contenu (CMS)</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Mettez à jour facilement votre contenu avec des CMS
                                tels que WordPress ou un système sur mesure.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">

                            <svg class="w-7 h-7 text-gray-500   mb-3" viewBox="0 0 24 24" fill="currentColor"
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Fonctionnalités Personnalisées </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Ajout de fonctionnalités comme des formulaires, des
                                galeries d’images, ou des boutiques en ligne.</p>
                        </div>

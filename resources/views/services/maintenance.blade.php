        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Maintenance et Support</h1>
                    <p class="hero_description" data-aos="fade-up">
                        Confiez-nous la maintenance de vos sites web et applications pour garantir leur bon fonctionnement et leur sécurité à long terme. Nous offrons des services de maintenance complets, incluant des mises à jour régulières, des correctifs de sécurité, et une surveillance continue pour détecter et résoudre les problèmes avant qu'ils n'affectent vos utilisateurs. Notre équipe d'experts est disponible 24/7 pour vous assurer une tranquillité d'esprit totale. Faites confiance à notre expertise pour prolonger la durée de vie de vos systèmes et optimiser leurs performances.
                    </p>

                    <div class="cta-links-area "><button class="tp-btn" onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service Maintenance')">Demander un devis</button>
                ...
                <div class="image_hero " data-tilt="">
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper"><img class="img-fluid " src="{{ asset('img/services/maintenance.png') }}"
                                alt="" draggable="false">
                            <div class="radar"></div>
                            <div class="orbit"> </div>
                        </div>
            ...
            <div class="features">
                <div class="features_content">
                    <div class="headlining">
                        <div class="pre-title" data-aos="fade-up">Gardez Vos Systèmes Performants</div>
                        <h3 data-aos="fade-right">Une Maintenance Sans Souci pour Vos Systèmes</h3>
                        <p data-aos="fade-right">
                            Prolongez la durée de vie et les performances de vos outils numériques avec nos services de maintenance. 
                        </p>
                    </div>
                    <article class="features_articles">
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">Mises à Jour de Sécurité</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Protégez vos systèmes avec des correctifs réguliers. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Monitoring en Temps Réel  </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Surveillance continue pour détecter les anomalies.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <p class="mb-3 font-normal text-gray-500  ">Améliorez la vitesse et la fiabilité de vos systèmes.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Gestion des Sauvegardes  </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Planification et récupération rapide des données.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Rapports Mensuels  </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Compte rendu des actions effectuées et des améliorations proposées.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Réparation des Bugs</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Intervention rapide pour corriger les erreurs.  </p>
                        </div>

        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Ux & UI Design</h1>
                    <p class="hero_description" data-aos="fade-up">
                        L’expérience utilisateur est au cœur de tout projet réussi. Nous concevons des interfaces qui
                        allient esthétisme et facilité d’utilisation. Nos experts en UX/UI design travaillent avec vous pour
                        créer des designs intuitifs et engageants qui répondent aux besoins de vos utilisateurs. Que ce soit
                        pour des wireframes, des prototypes ou des tests utilisateurs, nous vous accompagnons à chaque étape
                        pour garantir une expérience utilisateur optimale. Faites confiance à notre expertise pour
                        transformer vos idées en interfaces captivantes et efficaces.
                    </p>

                    <div class="cta-links-area "><button class="tp-btn"
                            onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service UX UI')">Demander un
                            devis</button>
                ...
                <div class="image_hero " data-tilt="">
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper"><img class="img-fluid " src="{{ asset('img/services/ui.png') }}"
                                alt="" draggable="false">
                            <div class="radar"></div>
                            <div class="orbit"> </div>
                        </div>
            ...
            <div class="features">
                <div class="features_content">
                    <div class="headlining">
                        <div class="pre-title" data-aos="fade-up">Un Design qui Captive</div>
                        <h3 data-aos="fade-right">Des Designs qui Captivent Vos Utilisateurs</h3>
                        <p data-aos="fade-right">
                            Offrez une expérience utilisateur fluide avec des designs attrayants et intuitifs. </p>
                    </div>
                    <article class="features_articles">
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Wireframes et Prototypes</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Création de maquettes interactives pour visualiser
                                vos idées avant le développement. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Analyse du Comportement Utilisateur </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Études pour comprendre vos utilisateurs et
                                optimiser leur parcours.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Charte Graphique Personnalisée </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Création de palettes de couleurs, typographies et
                                éléments visuels uniques.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <p class="mb-3 font-normal text-gray-500  ">Ajoutez des animations subtiles pour enrichir
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Design Accessible </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Respect des normes d’accessibilité pour garantir
                                l’inclusivité.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Tests Utilisateurs </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Recueillez des retours pour ajuster votre design
                                et améliorer l’ergonomie.</p>
                        </div>

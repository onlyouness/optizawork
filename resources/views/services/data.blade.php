        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Data & Analyse</h1>
                    <p class="hero_description" data-aos="fade-up">
                        Nos experts analysent vos données pour vous fournir des insights clairs et actionnables. Prenez des décisions éclairées grâce à nos solutions avancées. Nous utilisons des techniques de pointe pour transformer vos données brutes en informations précieuses. Que ce soit pour des analyses descriptives, prédictives ou prescriptives, nous vous aidons à comprendre vos données et à les utiliser pour optimiser vos processus et stratégies. Faites confiance à notre expertise pour améliorer votre prise de décision et atteindre vos objectifs commerciaux.
                    </p>

                    <div class="cta-links-area "><button class="tp-btn"
                            onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service Data')">Demander un
                            devis</button>
                ...
                <div class="image_hero " data-tilt="">
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper"><img class="img-fluid " src="{{ asset('img/services/data.png') }}"
                                alt="" draggable="false">
                            <div class="radar"></div>
                            <div class="orbit"> </div>
                        </div>
            ...
            <div class="features">
                <div class="features_content">
                    <div class="headlining">
                        <div class="pre-title" data-aos="fade-up">Transformez Vos Données en Décisions Stratégiques</div>
                        <h3 data-aos="fade-right">Exploitez la Puissance de Vos Données</h3>
                        <p data-aos="fade-right">
                            Prenez des décisions éclairées grâce à nos solutions d’analyse de données.
                        </p>
                    </div>
                    <article class="features_articles">
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Collecte Automatisée des Données</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Utilisez des outils pour centraliser vos
                                informations efficacement. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Nettoyage et Transformation des Données </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Éliminez les doublons et corrigez les incohérences
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Visualisation Dynamique </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Graphiques interactifs pour interpréter rapidement
                                vos données.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Modèles Prédictifs </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Anticipez les tendances grâce à des algorithmes
                                avancés.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Sécurité des Données </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Protection et respect des normes RGPD. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Solutions Big Data</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Gérez des volumes massifs de données pour des
                                projets complexes.</p>
                        </div>

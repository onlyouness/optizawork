        ...
        <section class="page-hero">
            ...
            <section class="hero-content">
                <div class="headlines">
                    ...
                    <h1 class="hero-title" data-aos="fade-up">Cloud & Hébergement</h1>
                    <p class="hero_description" data-aos="fade-up">Protégez vos applications et sites web avec nos solutions
                        cloud fiables. Profitez d’un temps de fonctionnement optimal et d’une gestion simplifiée. Nos
                        services cloud vous offrent une sécurité renforcée, une performance élevée et une flexibilité
                        inégalée. Que vous ayez besoin d'hébergement pour un site web, une application ou une infrastructure
                        complète, notre équipe d'experts est là pour vous accompagner. Bénéficiez de sauvegardes
                        automatiques, de plans flexibles et d'un support technique disponible 24/7. Faites confiance à notre
                        expertise pour garantir la continuité de vos activités en ligne et atteindre vos objectifs
                        commerciaux.</p>

                    <div class="cta-links-area "><button class="tp-btn"
                            onclick="sendWhatsAppMessage('Demander Un Devis Pour Le Service Cloud')">Demander un
                            devis</button>
                    </div>
                </div>
                ...
                <div class="image_hero " data-tilt="">
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper"><img class="img-fluid " src="{{ asset('img/services/cloud.png') }}"
                                alt="" draggable="false">
                            <div class="radar"></div>
                            <div class="orbit"> </div>
                        </div>
            ...
            <div class="features">
                <div class="features_content">
                    <div class="headlining">
                        <div class="pre-title" data-aos="fade-up">Hébergement Sécurisé et Performant</div>
                        <h3 data-aos="fade-right">Hébergement et Solutions Cloud Fiables</h3>
                        <p data-aos="fade-right">
                            Assurez la sécurité et la performance de vos plateformes numériques avec nos services cloud.
                        </p>
                    </div>
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Hébergement Haute Performance</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Serveurs rapides et fiables pour un temps de
                                chargement optimal. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Sauvegardes Automatisées </h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Protection contre la perte de données avec des
                                copies régulières.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <p class="mb-3 font-normal text-gray-500  ">Options d’hébergement adaptées à toutes les tailles
                                d’entreprise.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Réseau de Distribution de Contenu (CDN)</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  "> Accélérez le chargement des pages partout dans le
                                monde.</p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Support Technique 24/7</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Assistance disponible à tout moment. </p>
                        </div>
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow feature_card "
                            data-aos="fade-up">
                            ...
                            <a href="#">
                                <h5 class=" title_feature mb-2 text-2xl font-semibold tracking-tight text-gray-900  ">
                                    Environnements Dédiés</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-500  ">Isolation complète pour des performances maximales.
                            </p>
                        </div>
